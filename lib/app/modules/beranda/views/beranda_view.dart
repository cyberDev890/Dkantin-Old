...
class BerandaView extends GetView<BerandaController> {
    ...
    return MediaQuery(
      ...
      child: Scaffold(
        ...
        body: RefreshIndicator(
          onRefresh: () async => await berandaController.loadData(),
          child: content(context, penjualanBulanIni, penjualanHariIni),
        ),
      ),
    );
  }
  ...
  Widget content(
      BuildContext context, int penjualanBulanIni, int penjualanHariIni) {
    return Container(
